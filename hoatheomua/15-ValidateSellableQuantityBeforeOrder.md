...
### Alternative Flow
- **ALT-01**: Số lượng yêu cầu vượt quá khả năng bán nhưng vẫn còn hàng; hệ thống thông báo số lượng tối đa có thể đặt và cho phép khách chấp nhận số lượng đó.
...
- **EXC-03**: Hệ thống kiểm tra tổng nhu cầu vật liệu của toàn giỏ, không kiểm tra riêng lẻ từng dòng.
...
## Non-Functional
- Việc kiểm tra và giữ chỗ phải thực hiện trong một giao dịch nguyên tử, không cho phép hai đơn cùng chiếm một đơn vị vật liệu.
