...
### Alternative Flow
- **ALT-01**: Vật liệu vai trò mặc định SUPPORT dưới ngưỡng; hệ thống hiển thị ở mức cảnh báo thấp hơn và ghi rõ không ảnh hưởng khả năng bán nhưng ảnh hưởng chất lượng bó hoa.
- **ALT-02**: Hệ thống hiển thị trạng thái tồn kho ổn định.
...
- **When**: Quản trị viên mở dashboard
- **Then**: Combo hoa xuất hiện trong khối cảnh báo kèm tên vật liệu nút thắt đang gây thiếu

### AC-003
- **Given**: Vật liệu vai trò mặc định SUPPORT có tồn khả dụng bằng 0
- **When**: Cảnh báo được hiển thị
- **Then**: Cảnh báo ở mức thấp hơn và ghi rõ không ảnh hưởng số lượng có thể bán

### AC-004
- **Given**: Một cảnh báo tồn thấp đang hiển thị
- **When**: Quản trị viên bấm vào cảnh báo
- **Then**: Hệ thống mở biểu mẫu nhập kho với vật liệu đã được chọn sẵn
