# UT-053-07: Từ chối xóa Mockup khi chưa đăng nhập

## Thông tin tài liệu
- **Tiêu đề (bắt buộc)**: Từ chối xóa Mockup khi chưa đăng nhập
- **Ghi chú**: Kịch bản authorization - user chưa đăng nhập không được phép xóa mockup.

## Metadata quản trị tài liệu
- **Mã tài liệu**: UT-053-07
- **Phiên bản**: v0.1
...
- **Unit under test (bắt buộc)**: MockupController.DeleteMockup (authentication)
- **Loại**: Error
