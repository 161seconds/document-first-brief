...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| [**BR-169**](https://document-first.vnzdna.com/projects/117393d8-1afc-4c89-baa9-9aeea430cdcd/documents/9723aab3-235c-4aed-9784-74ad851d8b5c) | Trạng thái quản lý của Mockup | Quản lý Mockup | Mockup chỉ được có một trong hai trạng thái quản lý tại một thời điểm. | Mockup tồn tại trong hệ thống. | Mockup phải ở một trong hai trạng thái: Hoạt động hoặc Không hoạt động. Hệ thống hiển thị và xử lý đúng trạng thái hiện tại của Mockup. | Không cho phép một Mockup đồng thời ở cả trạng thái Hoạt động và Không hoạt động. | User Story Admin chuyển trạng thái Mockup | BA / Product Owner | STORY-052 | Draft | v0 | 2026-08-25 | — |
| [**BR-170**](https://document-first.vnzdna.com/projects/117393d8-1afc-4c89-baa9-9aeea430cdcd/documents/8f83e5e2-0f8b-45fe-98ba-f0b3b252ae7c) | Ảnh hưởng của Mockup Không hoạt động với khách hàng | Quản lý Mockup | Mockup ở trạng thái Không hoạt động không được hiển thị cho khách hàng trong danh sách Mockup khả dụng và không được sử dụng cho yêu cầu tạo mẫu hoa mới. | Khách hàng truy cập bước chọn Mockup hoặc hoàn thành yêu cầu tạo mẫu hoa có sử dụng Mockup. | Hệ thống chỉ cho phép hiển thị và sử dụng Mockup đang ở trạng thái Hoạt động. Mockup Không hoạt động phải bị loại khỏi danh sách Mockup khả dụng và không được dùng để tạo yêu cầu mới. | Không áp dụng cho các yêu cầu tạo mẫu hoa đã được tạo thành công trước khi Mockup chuyển sang Không hoạt động. | User Story Admin chuyển trạng thái Mockup | BA / Product Owner | STORY-052 | Draft | v0 | 2026-08-25 | — |
| [**BR-171**](https://document-first.vnzdna.com/projects/117393d8-1afc-4c89-baa9-9aeea430cdcd/documents/c9a21221-3060-4a0e-bedf-e43b09f97205) | Ảnh hưởng của Mockup Hoạt động với khách hàng | Quản lý Mockup | Mockup ở trạng thái Hoạt động được xem là Mockup khả dụng để hệ thống có thể hiển thị cho khách hàng nếu thỏa các điều kiện hiển thị khác của hệ thống. | Khách hàng truy cập bước chọn Mockup trong quy trình khởi tạo mẫu hoa. | Hệ thống có thể đưa Mockup Hoạt động vào danh sách Mockup khả dụng nếu Mockup thỏa các điều kiện hiển thị khác của hệ thống. | Nếu Mockup không thỏa điều kiện hiển thị khác của hệ thống thì không bắt buộc hiển thị cho khách hàng dù đang ở trạng thái Hoạt động. | User Story Admin chuyển trạng thái Mockup | BA / Product Owner | STORY-052 | Draft | v0 | 2026-08-25 | — |
| [**BR-172**](https://document-first.vnzdna.com/projects/117393d8-1afc-4c89-baa9-9aeea430cdcd/documents/bcee63b0-301a-4869-a10d-ae488271c802) | Chuyển sang Không hoạt động không xóa Mockup | Quản lý Mockup | Chuyển Mockup sang trạng thái Không hoạt động không xóa Mockup khỏi Core Database và không làm mất liên kết với các yêu cầu tạo mẫu hoa đã sử dụng Mockup đó trước đó. | Admin chuyển trạng thái Mockup từ Hoạt động sang Không hoạt động. | Hệ thống chỉ cập nhật trạng thái quản lý của Mockup, giữ nguyên bản ghi Mockup và các liên kết với yêu cầu tạo mẫu hoa đã tồn tại. | Không áp dụng cho chức năng xóa Mockup nếu có User Story riêng quy định. | User Story Admin chuyển trạng thái Mockup | BA / Product Owner | STORY-052 | Draft | v0 | 2026-08-25 | — |
| [**BR-173**](https://document-first.vnzdna.com/projects/117393d8-1afc-4c89-baa9-9aeea430cdcd/documents/d40cd52b-de2d-4cd8-9c5e-2951b3d94df7) | Quyền thay đổi trạng thái Mockup | Quản lý Mockup | Chỉ Admin có quyền quản lý Mockup mới được phép chuyển trạng thái Mockup. | Người dùng gửi yêu cầu chuyển trạng thái Mockup. | Hệ thống kiểm tra quyền trước khi cập nhật trạng thái. Nếu người dùng có quyền quản lý Mockup, hệ thống cho phép xử lý yêu cầu; nếu không có quyền, hệ thống từ chối yêu cầu. | Người dùng không có quyền quản lý Mockup không được thay đổi trạng thái Mockup trong bất kỳ trường hợp nào. | User Story Admin chuyển trạng thái Mockup | BA / Product Owner | STORY-052 | Draft | v0 | 2026-08-25 | — |
| [**BR-174**](https://document-first.vnzdna.com/projects/117393d8-1afc-4c89-baa9-9aeea430cdcd/documents/0a76650e-2524-49a9-ab5f-b3df68cc03e2) | Tính nhất quán khi cập nhật trạng thái Mockup | Quản lý Mockup | Khi cập nhật trạng thái Mockup thất bại, hệ thống phải giữ nguyên trạng thái trước đó của Mockup và không được lưu dữ liệu ở trạng thái dở dang hoặc không đồng nhất. | Hệ thống xử lý yêu cầu chuyển trạng thái Mockup. | Nếu cập nhật thành công, trạng thái mới được lưu nhất quán vào Core Database. Nếu cập nhật thất bại, trạng thái trước đó của Mockup phải được giữ nguyên. | Không cho phép lưu một phần dữ liệu khiến trạng thái hiển thị và trạng thái trong Core Database không đồng nhất. | User Story Admin chuyển trạng thái Mockup | BA / Product Owner | STORY-052 | Draft | v0 | 2026-08-25 | — |
| [**BR-175**](https://document-first.vnzdna.com/projects/117393d8-1afc-4c89-baa9-9aeea430cdcd/documents/6f062971-445e-448d-89f1-339b5baa2064) | Xác nhận trước khi thay đổi trạng thái Mockup | Quản lý Mockup | Hệ thống phải hiển thị popup xác nhận trước khi thực hiện thao tác chuyển trạng thái Mockup. | Admin chọn thao tác Chuyển sang Hoạt động hoặc Chuyển sang Không hoạt động. | Hệ thống hiển thị popup xác nhận. Chỉ khi Admin xác nhận, hệ thống mới được cập nhật trạng thái Mockup. | Nếu Admin hủy hoặc đóng popup xác nhận, hệ thống không được cập nhật trạng thái Mockup. | User Story Admin chuyển trạng thái Mockup | BA / Product Owner | STORY-052 | Draft | v0 | 2026-08-25 | — |
