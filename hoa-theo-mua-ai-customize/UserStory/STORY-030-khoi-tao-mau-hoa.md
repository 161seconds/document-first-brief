...
|---|---|
| **Loại** | Story |
| **User Story** | Là một khách hàng đã đăng nhập, tôi muốn khởi tạo yêu cầu tạo mẫu hoa từ một Combo đã chọn và cấu hình các lựa chọn như Size, kiểu bó, Mockup, giấy gói, ruy băng, để lưu lại đầy đủ đầu vào làm cơ sở cho AI tạo mẫu hoa sau này. |
| **Sprint** | S1 |
| **Priority** | Must |
| **Assignee (BE)** | Hoàng Thị Khánh Linh |
| **Assignee (QA)** | Hoàng Thị Khánh Linh |
...
Khách hàng bắt đầu quy trình khởi tạo mẫu hoa bằng cách chọn “Tạo mẫu hoa” trên một Combo Card trong danh sách mẫu hoa / Combo.
...
- Khách hàng đang ở một bước sau bước đầu tiên của quy trình.
- Khách hàng chọn “Quay lại”.
- Hệ thống chuyển khách hàng về bước trước đó.
- Hệ thống giữ nguyên các thông tin và lựa chọn khách hàng đã thực hiện nếu các lựa chọn đó còn hợp lệ.
- Khách hàng có thể chỉnh sửa dữ liệu và tiếp tục quy trình.

#### ALT-02 — Khách hàng xem preview hình ảnh trong các bước chọn bằng hình
- Khách hàng đang ở bước chọn kiểu bó, Mockup, giấy gói hoặc ruy băng.
- Khách hàng chọn xem hình ảnh chi tiết.
- Hệ thống hiển thị Image Preview Modal với hình ảnh kích thước lớn hơn.
- Khách hàng đóng Image Preview Modal và tiếp tục lựa chọn.

#### ALT-03 — Size cho phép tăng số lượng Combo nguồn
- Khách hàng đã chọn một Size.
- Cấu hình của cửa hàng cho Size đó cho phép tăng số lượng Combo nguồn.
- Hệ thống hiển thị lựa chọn tăng số lượng Combo nguồn.
- Khách hàng chọn lựa chọn này.
- Hệ thống ghi nhận cấu hình Combo đã chọn theo Size gồm Combo nguồn và số lượng tương ứng theo cấu hình Size.

#### ALT-04 — Size cho phép kết hợp thêm Combo khác
- Khách hàng đã chọn một Size.
- Cấu hình của cửa hàng cho Size đó cho phép kết hợp thêm một hoặc nhiều Combo khác.
- Hệ thống hiển thị các Combo được phép kết hợp và giới hạn số lượng Combo được kết hợp theo cấu hình Size.
- Khách hàng chọn các Combo kết hợp trong phạm vi được phép.
- Hệ thống ghi nhận cấu hình Combo đã chọn theo Size gồm Combo nguồn và các Combo kết hợp đã chọn.

### Exception Flows

#### EXC-01 — Tên yêu cầu tạo mẫu hoa không hợp lệ
- Khách hàng để trống hoặc nhập Tên yêu cầu tạo mẫu hoa không hợp lệ.
- Khách hàng chọn “Tiếp theo” hoặc “Hoàn thành”.
- Hệ thống loại bỏ khoảng trắng ở đầu và cuối của Tên trước khi kiểm tra.
- Hệ thống kiểm tra Tên có độ dài từ 1 đến 100 ký tự.
- Hệ thống hiển thị lỗi tại trường Tên nếu dữ liệu không hợp lệ.
- Hệ thống không cho phép khách hàng chuyển sang bước tiếp theo hoặc hoàn thành cho đến khi Tên hợp lệ.

#### EXC-02 — Combo nguồn hoặc Combo trong cấu hình Combo đã chọn theo Size không còn khả dụng
- Khách hàng đã chọn cấu hình Combo theo Size.
- Khách hàng chọn “Hoàn thành”.
- Hệ thống kiểm tra lại Combo nguồn và các Combo trong cấu hình Combo đã chọn theo Size.
- Hệ thống phát hiện ít nhất một Combo không còn khả dụng.
- Hệ thống không tạo yêu cầu tạo mẫu hoa.
- Hệ thống thông báo Combo đã chọn không còn khả dụng và yêu cầu khách hàng chọn lại cấu hình phù hợp.

#### EXC-03 — Size hoặc cấu hình Combo theo Size không hợp lệ
- Khách hàng chọn một Size hoặc cấu hình Combo theo Size.
- Hệ thống kiểm tra cấu hình hiện hành của cửa hàng.
- Hệ thống phát hiện Size không còn khả dụng hoặc cấu hình Combo đã chọn không còn hợp lệ.
- Hệ thống không cho phép tiếp tục.
- Hệ thống yêu cầu khách hàng chọn lại Size hoặc cấu hình Combo hợp lệ.

#### EXC-04 — Chưa chọn dữ liệu bắt buộc trong các bước cấu hình
- Khách hàng chưa chọn Size, cấu hình Combo theo Size, kiểu bó, Mockup, giấy gói hoặc ruy băng.
- Khách hàng chọn “Hoàn thành”.
- Hệ thống không tạo yêu cầu tạo mẫu hoa.
- Hệ thống hiển thị lỗi tại bước hoặc trường còn thiếu.
- Hệ thống yêu cầu khách hàng hoàn tất các lựa chọn bắt buộc trước khi tiếp tục.

#### EXC-05 — Mockup, kiểu bó, giấy gói hoặc ruy băng không còn khả dụng
- Khách hàng đã chọn Mockup, kiểu bó, giấy gói hoặc ruy băng.
- Khách hàng chọn “Hoàn thành”.
- Hệ thống kiểm tra lại trạng thái khả dụng của các dữ liệu đã chọn.
- Hệ thống phát hiện ít nhất một dữ liệu không còn khả dụng.
- Hệ thống không tạo yêu cầu tạo mẫu hoa.
- Hệ thống thông báo dữ liệu đã chọn không còn khả dụng và yêu cầu khách hàng chọn lại.

#### EXC-06 — Lỗi khi lưu dữ liệu
- Khách hàng đã cung cấp đầy đủ dữ liệu hợp lệ.
- Khách hàng chọn “Hoàn thành”.
- Hệ thống gặp lỗi trong quá trình lưu.
- Hệ thống không tạo yêu cầu tạo mẫu hoa.
- Hệ thống thông báo: “Tạo yêu cầu mẫu hoa thất bại. Vui lòng thử lại.”
- Dữ liệu khách hàng đã nhập được giữ lại nếu có thể.
...
- **Then**:
  - Hệ thống phải điều hướng khách hàng đến trang form khởi tạo yêu cầu tạo mẫu hoa.
  - Hệ thống phải ghi nhận Combo được chọn là Combo nguồn ban đầu của quy trình.

### AC-002
- **Given**: Khách hàng đang ở trang form khởi tạo yêu cầu tạo mẫu hoa.
- **When**: Form được hiển thị.
- **Then**:
  - Hệ thống phải hiển thị thông tin Combo nguồn từ Core Database.
  - Thông tin hiển thị gồm hình ảnh, tên Combo, mô tả, thành phần nguyên liệu và giá Combo.

### AC-003
- **Given**: Khách hàng đang nhập Tên yêu cầu tạo mẫu hoa.
- **When**: Khách hàng chọn “Tiếp theo”.
- **Then**:
  - Hệ thống phải loại bỏ khoảng trắng ở đầu và cuối của Tên trước khi kiểm tra.
  - Tên phải có độ dài từ 1 đến 100 ký tự; nếu Tên không hợp lệ, hệ thống không được chuyển sang bước tiếp theo và phải hiển thị lỗi tại trường Tên.

### AC-004
- **Given**: Tên yêu cầu tạo mẫu hoa hợp lệ.
- **When**: Khách hàng chuyển sang bước chọn Size.
- **Then**:
  - Hệ thống phải hiển thị danh sách Size khả dụng.
  - Tại một thời điểm khách hàng chỉ được chọn một Size.

### AC-005
- **Given**: Khách hàng đã chọn một Size.
- **When**: Hệ thống tải cấu hình Combo theo Size.
- **Then**:
  - Hệ thống phải hiển thị các lựa chọn cấu hình Combo hợp lệ theo cấu hình của cửa hàng.
  - Các lựa chọn có thể gồm tăng số lượng Combo nguồn hoặc kết hợp thêm một hay nhiều Combo khác.
...
- **Then**:
  - Hệ thống phải ghi nhận Combo nguồn và số lượng tương ứng theo cấu hình Size.
  - Số lượng Combo nguồn không được vượt quá cấu hình mà cửa hàng cho phép đối với Size đã chọn.
...
- **Then**:
  - Hệ thống phải cho phép khách hàng chọn Combo kết hợp trong danh sách được cửa hàng cấu hình cho Size đó.
  - Số lượng Combo được kết hợp không được vượt quá giới hạn mà cửa hàng cấu hình cho Size đã chọn.

### AC-008
- **Given**: Khách hàng đã chọn cấu hình Combo theo Size.
- **When**: Hệ thống chuyển sang bước chọn kiểu bó.
- **Then**:
  - Hệ thống phải hiển thị danh sách kiểu bó có hình ảnh.
  - Tại một thời điểm khách hàng chỉ được chọn một kiểu bó.

### AC-009
- **Given**: Khách hàng đang ở bước chọn Mockup.
- **When**: Danh sách Mockup được hiển thị.
- **Then**:
  - Hệ thống phải truy xuất danh sách Mockup còn khả dụng từ Core Database.
  - Tại một thời điểm khách hàng chỉ được chọn một Mockup.

### AC-010
- **Given**: Khách hàng đang ở bước chọn giấy gói.
- **When**: Danh sách giấy gói được hiển thị.
- **Then**:
  - Hệ thống phải hiển thị danh sách giấy gói còn khả dụng.
  - Tại một thời điểm khách hàng chỉ được chọn một giấy gói.

### AC-011
- **Given**: Khách hàng đang ở bước chọn ruy băng.
- **When**: Danh sách ruy băng được hiển thị.
- **Then**:
  - Hệ thống phải hiển thị danh sách ruy băng còn khả dụng.
  - Tại một thời điểm khách hàng chỉ được chọn một ruy băng.
...
- **Then**:
  - Hệ thống phải kiểm tra lại trạng thái khả dụng của toàn bộ dữ liệu đã chọn.
  - Nếu có dữ liệu không còn khả dụng, hệ thống không được tạo yêu cầu tạo mẫu hoa.

### AC-013
- **Given**: Toàn bộ dữ liệu khởi tạo hợp lệ.
- **When**: Khách hàng chọn “Hoàn thành”.
- **Then**:
  - Hệ thống phải tạo một yêu cầu tạo mẫu hoa mới.
  - Yêu cầu phải liên kết với tài khoản khách hàng hiện tại, Combo nguồn ban đầu, cấu hình Combo đã chọn theo Size, Size, kiểu bó, Mockup, giấy gói và ruy băng đã chọn.

### AC-014
- **Given**: Yêu cầu tạo mẫu hoa được tạo thành công.
- **When**: Hệ thống lưu yêu cầu tạo mẫu hoa.
- **Then**:
  - Yêu cầu tạo mẫu hoa phải có trạng thái ban đầu là Bản nháp.
  - Hệ thống không được tự động chuyển sang trạng thái tạo AI.

### AC-015
- **Given**: Yêu cầu tạo mẫu hoa đã được tạo thành công.
- **When**: Khách hàng được chuyển đến màn hình Chi tiết yêu cầu tạo mẫu hoa.
- **Then**:
  - Hệ thống phải hiển thị đầy đủ thông tin của yêu cầu vừa được tạo.
  - Thông tin hiển thị gồm tên yêu cầu, ngày tạo, trạng thái, Combo nguồn ban đầu, cấu hình Combo đã chọn theo Size, Size, kiểu bó, Mockup, giấy gói và ruy băng.

### AC-016
- **Given**: Yêu cầu tạo mẫu hoa đã được tạo thành công.
- **When**: Màn hình Chi tiết yêu cầu tạo mẫu hoa được hiển thị.
- **Then**:
  - Hệ thống phải hiển thị chức năng “Tạo mẫu hoa bằng AI”.
  - Hệ thống chưa tự động gửi yêu cầu tạo mẫu hoa bằng AI cho đến khi khách hàng chủ động sử dụng chức năng này.

### AC-017
- **Given**: Khách hàng đã hoàn thành ít nhất một bước trong quy trình.
- **When**: Khách hàng chọn “Quay lại”.
- **Then**:
  - Hệ thống phải hiển thị lại các thông tin và lựa chọn đã thực hiện trước đó.
  - Khách hàng có thể thay đổi dữ liệu trước đó nếu dữ liệu đó còn hợp lệ.
...
| Rule ID | Link |
|---|---|
| BR-068 | [BR-068](https://document-first.vnzdna.com/projects/117393d8-1afc-4c89-baa9-9aeea430cdcd/documents/b1017f3c-b500-4d66-83a3-46b3a488d37f) |
| BR-069 | [BR-069](https://document-first.vnzdna.com/projects/117393d8-1afc-4c89-baa9-9aeea430cdcd/documents/a925fb05-3c5e-4592-8e0c-22a516df58a2) |
| BR-070 | [BR-070](https://document-first.vnzdna.com/projects/117393d8-1afc-4c89-baa9-9aeea430cdcd/documents/e85f0e09-9b6a-49a8-b62d-ccc467c2bb94) |
| BR-071 | [BR-071](https://document-first.vnzdna.com/projects/117393d8-1afc-4c89-baa9-9aeea430cdcd/documents/30761eaa-4df8-4e44-8d1e-efaba44782bf) |
| BR-072 | [BR-072](https://document-first.vnzdna.com/projects/117393d8-1afc-4c89-baa9-9aeea430cdcd/documents/2371ded1-c7f4-42a2-98a4-1c4f71d8095c) |
| BR-076 | [BR-076](https://document-first.vnzdna.com/projects/117393d8-1afc-4c89-baa9-9aeea430cdcd/documents/c5e7d260-7968-449d-b0a6-8de5602056d0) |
| BR-077 | [BR-077](https://document-first.vnzdna.com/projects/117393d8-1afc-4c89-baa9-9aeea430cdcd/documents/c67cdf93-5604-438a-a247-e5195bf0e46d) |
| BR-078 | [BR-078](https://document-first.vnzdna.com/projects/117393d8-1afc-4c89-baa9-9aeea430cdcd/documents/4e2249f4-842f-4159-a04c-295904f50ec3) |
| BR-079 | [BR-079](https://document-first.vnzdna.com/projects/117393d8-1afc-4c89-baa9-9aeea430cdcd/documents/71fd8ff3-1fbd-4ab8-969b-1256d2e70618) |
| BR-080 | [BR-080](https://document-first.vnzdna.com/projects/117393d8-1afc-4c89-baa9-9aeea430cdcd/documents/25e0fc0c-5927-4bab-8a46-86ff656fe108) |
| BR-267 | [BR-267](https://document-first.vnzdna.com/projects/117393d8-1afc-4c89-baa9-9aeea430cdcd/documents/cd17ed46-c350-48b4-8b58-db7f94e22bdf) |
| BR-268 | [BR-268](https://document-first.vnzdna.com/projects/117393d8-1afc-4c89-baa9-9aeea430cdcd/documents/73ba5a6b-3deb-48e4-a62c-efafae4cb33a) |
| BR-269 | [BR-269](https://document-first.vnzdna.com/projects/117393d8-1afc-4c89-baa9-9aeea430cdcd/documents/baa36bab-ae33-4c6c-827d-f7f775bcaede) |
| BR-270 | [BR-270](https://document-first.vnzdna.com/projects/117393d8-1afc-4c89-baa9-9aeea430cdcd/documents/922030ff-fc05-4b71-8059-2f0eb41dca4c) |
| BR-271 | [BR-271](https://document-first.vnzdna.com/projects/117393d8-1afc-4c89-baa9-9aeea430cdcd/documents/0c3e391d-29a6-4747-bd28-a0d056f2e2e1) |
