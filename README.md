...
| :-: | :--- | :--- | :--- | :--- |
| **1** | `hoa-theo-mua-ai-custom` | **HTM_AI_Custom** (Gói theo Story) | [`hoa-theo-mua-ai-custom/`](file:///d:/VNZ/document-first-brief/hoa-theo-mua-ai-custom/README.md) | **Tài liệu theo cấu trúc gói Story**: Mỗi thư mục chứa đầy đủ User Story, System Test và Business Rules liên quan. |
| **2** | `hoa-theo-mua-ai-customize` | **HTM_AI_Customize** (Cấu trúc phân tầng) | [`hoa-theo-mua-ai-customize/`](file:///d:/VNZ/document-first-brief/hoa-theo-mua-ai-customize/README.md) | **Cá nhân hóa mua sắm bằng AI**: Tạo mẫu phối hoa độc bản theo prompt, tạo thiệp AI tại checkout (`in` / `viết tay`), thiệp handmade, quản lý mockup, kiểu gói và cấu hình size hoa custom AI. |
| **3** | `hoa-theo-mua-ai-marketing` | **HTM_Marketing_AI** | [`hoa-theo-mua-ai-marketing/`](file:///d:/VNZ/document-first-brief/hoa-theo-mua-ai-marketing/README.md) | **Marketing & Truyền thông AI**: Tự động sinh caption & hashtag bằng AI, viết lại nội dung theo từng nền tảng, sinh ảnh đa tỷ lệ (1:1, 4:5, 9:16, 16:9, 2:1), lên lịch & tự động đăng bài đa kênh, thu thập báo cáo đa nền tảng (XLSX). |
| **4** | `hoa-theo-mua-material-management` | **HTM_Material_Management** | [`hoa-theo-mua-material-management/`](file:///d:/VNZ/document-first-brief/hoa-theo-mua-material-management/README.md) | **Quản lý Vật liệu & Định lượng Combo**: Bóc tách nguyên vật liệu thô (hoa cành, hoa phụ, phụ kiện), thiết lập công thức BOM cho Combo hoa, tính toán số lượng khả dụng có thể bán (AvailableForSale) theo thời gian thực và quản lý vòng đời giữ hàng (Reservation). |
| **5** | `meetly` | **Meetly** | [`meetly/`](file:///d:/VNZ/document-first-brief/meetly/README.md) | **Khảo sát & Tối ưu Lịch họp Nhóm qua Heatmap**: Khảo sát thời gian đa mô hình (`Dates and Times`, `Weekdays`), ma trận Heatmap trực quan chia lưới 15 phút, bình chọn 2 chế độ (Rảnh/Bận) kéo thả và định danh phi tập trung theo sự kiện. |
| **6** | `swp391-cross-border-racehorse-transport-system` | **Cross-Border Racehorse Transport** | [`swp391-cross-border-racehorse-transport-system/`](file:///d:/VNZ/document-first-brief/swp391-cross-border-racehorse-transport-system/README.md) | **Vận Chuyển Ngựa Đua Xuyên Biên Giới**: Logistics quốc tế, kiểm dịch thú y, thủ tục hải quan và giám sát hành trình thời gian thực. |
