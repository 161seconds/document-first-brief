...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ST-US05-09 | US-05 | EXC | REGRESSION | P1 | Chưa tham gia sự kiện | 1. Truy cập Heatmap khi chưa tham gia sự kiện | URL trực tiếp | Hệ thống từ chối truy cập. | US-05/AC-004 | Kiểm tra bảo vệ dữ liệu khảo sát đối với người ngoài sự kiện. | QA Team | Draft |
