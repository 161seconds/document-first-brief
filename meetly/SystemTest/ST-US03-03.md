...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ST-US03-03 | US-03 | EXC | REGRESSION | P1 | Đang ở màn hình nhập ShortCode | 1. Nhập ShortCode không có trong hệ thống<br>2. Xác nhận | ShortCode không tồn tại: 'INVALID999' | Hệ thống hiển thị thông báo ShortCode không hợp lệ. | US-03/AC-003 | Kiểm tra validation khi nhập mã sự kiện không tồn tại. | QA Team | Draft |
