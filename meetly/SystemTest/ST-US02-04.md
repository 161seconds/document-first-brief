...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ST-US02-04 | US-02 | Main | REGRESSION | P1 | Admin đã mở form chỉnh sửa | 1. Admin mở màn hình chỉnh sửa | Sự kiện đang có dữ liệu tên, loại, danh sách ngày | Các trường hiển thị đầy đủ dữ liệu hiện tại của sự kiện. | US-02/AC-005 | Đảm bảo form chỉnh sửa điền sẵn (pre-fill) dữ liệu hiện tại. | QA Team | Draft |
