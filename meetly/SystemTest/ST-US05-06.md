...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ST-US05-06 | US-05 | Main | SMOKE | P1 | Đã có bình chọn trên Heatmap | 1. Di chuyển chuột đến một ô trên Heatmap | Ô có bình chọn | Hệ thống hiển thị số người đang rảnh tại mốc thời gian đó. | US-05/AC-003 | Kiểm tra tooltip hiển thị số lượng và danh sách người rảnh khi hover. | QA Team | Draft |
