...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ST-US04-05 | US-04 | Main | SMOKE | P1 | Chính sách sự kiện cho phép bỏ trống mật khẩu | 1. Nhập username hợp lệ<br>2. Để trống mật khẩu<br>3. Xác nhận | Username: 'guest_quick', Password: [Trống] | Tài khoản được tạo thành công nếu chính sách cho phép bỏ trống mật khẩu. | US-04/AC-004, BR-10 | Kiểm tra tuân thủ BR-10: mật khẩu là không bắt buộc. | QA Team | Draft |
