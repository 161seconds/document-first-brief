...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ST-US02-09 | US-02 | ALT / Main | FULL | P1 | Sự kiện đã có bình chọn ở ngày X | 1. Xóa ngày X đã có người bình chọn<br>2. Xác nhận lưu | Xóa ngày X | Ngày bị xóa cùng toàn bộ bình chọn tương ứng; các bình chọn khác vẫn được giữ nguyên. | US-02/AC-006, BR-07 | Kiểm tra quy tắc BR-07 cascade delete các bình chọn của ngày bị xóa. | QA Team | Draft |
