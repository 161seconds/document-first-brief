...
Tài liệu TDD-011 được kiểm chứng trực tiếp bởi các test case trong file [All_TestCase_Templates.md](file:///d:/VNZ/document-first-brief/hoatheomua/UnitTest/MaterialManagement/All_TestCase_Templates.md) và [GetComboSpecificationTest.cs](file:///d:/VNZ/document-first-brief/hoatheomua/Code/ServiceTest/GetComboSpecificationTest.cs):
