# UT-062-08: Từ chối cập nhật Config khi chưa đăng nhập

## Thông tin tài liệu
- **Tiêu đề (bắt buộc)**: Từ chối cập nhật Config khi chưa đăng nhập
- **Ghi chú**: Kịch bản authentication - user chưa đăng nhập không được phép cập nhật config.

## Metadata quản trị tài liệu
- **Mã tài liệu**: UT-062-08
- **Phiên bản**: v0.1
...
- **Unit under test (bắt buộc)**: ConfigController.UpdateConfig (authentication)
- **Loại**: Error
...
- **Loại**: TDD
- **Mã**: TDD-062
- **Section**: Ví dụ 6 - Chưa đăng nhập
